...
from od_utils import Od_WebcamVideoStream, draw_boxes_and_labels
...
PATH_TO_LABELS = os.path.join(CWD_PATH, 'model', 'data', 'mscoco_label_map.pbtxt')
...
if __name__ == '__main__':
    ...
    video_capture = Od_WebcamVideoStream(src=args.video_source,
                                      width=args.width,
